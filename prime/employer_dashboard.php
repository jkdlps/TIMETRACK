  ...
  <nav id="sidebarMenu" class="collapse d-lg-block sidebar collapse bg-white">
    <div class="position-sticky">
      <div class="list-group list-group-flush mx-3 mt-4">
        <a href="employee_dashboard.php" class="list-group-item list-group-item-action py-2 ripple" aria-current="true active">
          <i class="fas fa-tachometer-alt fa-fw me-3"></i><span>Employer Dashboard</span>
        </a>
        <a href="update-form.php" class="list-group-item list-group-item-action py-2 ripple">
          <i class="fas fa-chart-area fa-fw me-3"></i><span>Update Info</span>
        </a>
        <?php
        ...
        ?>
        <a href="logout.php" class="list-group-item list-group-item-action py-2 ripple"><i class="fas fa-chart-line fa-fw me-3"></i><span>Log Out</span></a>
        <a href="employer_view_employees.php" class="list-group-item list-group-item-action py-2 ripple">
          <i class="fas fa-chart-pie fa-fw me-3"></i><span>View Employees</span>
        </a>
        <a href="employer_view_admins.php" class="list-group-item list-group-item-action py-2 ripple"><i class="fas fa-chart-bar fa-fw me-3"></i><span>View Admins</span></a>
        <a href="employer_view_dtr.php" class="list-group-item list-group-item-action py-2 ripple"><i class="fas fa-globe fa-fw me-3"></i><span>View Daily Time Records</span></a>
        <a href="employee_dtr_requests.php" class="list-group-item list-group-item-action py-2 ripple"><i class="fas fa-globe fa-fw me-3"></i><span>View Daily Time Record Change Requests</span></a>
        <a href="employee_view_leaves.php" class="list-group-item list-group-item-action py-2 ripple"><i class="fas fa-globe fa-fw me-3"></i><span>View Employees on Leave</span></a>
        <a href="employee_view_leave_requests.php" class="list-group-item list-group-item-action py-2 ripple"><i class="fas fa-globe fa-fw me-3"></i><span>View Leave Requests</span></a>
      </div>
    </div>
  </nav>
  <!-- Sidebar -->
