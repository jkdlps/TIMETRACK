            ...
            <div class="mask" style="background-color: rgba(0, 0, 0, 0.6);">
              <div class="d-flex justify-content-center align-items-center h-100">
                <div class="text-white text-center">
                  <h1 class="mb-3">GPS Timekeeping System</h1>
                  <h5 class="mb-4">Developed for Onsite and Remote Working Employees of Barangay Pulong Buhangin, Santa Maria, Bulacan</h5>
                  <a
      ...
      <div class="container">
        ...
        <section>
          <div class="row">
            ...
            <div class="col-md-6 gx-5 mb-4">
              <h4><strong>Developed by BSIT 4-1 Group 6</strong></h4>
              <table>
        <tr>
            <th>Developers</th>
            <th>Roles</th>
